...
class MessageBroker {
    ...
    async init() {
        ...
        // OK FUNCIONA const RABBITMQ_URL = accessEnv("RABBITMQ_URL", 'amqp://queue-service:5672');
        const RABBITMQ_URL = accessEnv("RABBITMQ_URL", 'amqp://51.15.230.124:5672');
    ...
    async send(queue, msg) {
        ...
        let resp = await this.channel.sendToQueue(queue, msg);
        return resp;
    }
