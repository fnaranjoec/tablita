...
// ********************************************* CLUSTERPROCESSING **************************************
export class ClusterProcessingModel extends Model {}
ClusterProcessingModel.init(
    {
        client_id: {
            allowNull: false,
            primaryKey: true,
    ...
    {
        modelName: "cluster_processing",
        tableName: "cluster_processing",
        timestamps: false,
        createdAt: false,
        updatedAt: false,
        sequelize
...
// --- COUPONS BY CAMPAIGN ---
export class CouponsByCampaignModel extends Model {}
CouponsByCampaignModel.init(
    {
        id: {
            allowNull: false,
            primaryKey: true,
    ...
    {
        sequelize,
        modelName: "vwCouponsByCampaign",
        tableName: "vwCouponsByCampaign",
        timestamps: false,
        createdAt: false,
        updatedAt: false,
        underscored : false,
...
// --- COUPONS BY DOCTOR ---
export class CouponsByDoctorModel extends Model {}
CouponsByDoctorModel.init(
    {
        id: {
            allowNull: false,
            primaryKey: true,
    ...
    {
        sequelize,
        modelName: "vwCouponsByDoctor",
        tableName: "vwCouponsByDoctor",
        timestamps: false,
        createdAt: false,
        updatedAt: false,
        underscored : false,
...
// ----------------------------------------------------- VWCLUSTERPROCESSING ------------------
export class viewClusterProcessingModel extends Model {}
viewClusterProcessingModel.init(
    {
        client_id: {
            allowNull: false,
            primaryKey: true,
    ...
    {
        modelName: "vwClusterProcessing",
        tableName: "vwClusterProcessing",
        timestamps: true,
        createdAt: 'created',
        updatedAt: false,
        sequelize
...
// ----------------------------------------------------- VWREDIMEDCOUPON ------------------
export class viewRedimedCouponModel extends Model {}
viewRedimedCouponModel.init(
    {
        coupon_id: {
            allowNull: false,
            primaryKey: true,
    ...
    {
        modelName: "vwredimedcoupon",
        tableName: "vwredimedcoupon",
        timestamps: false,
        createdAt: false,
        updatedAt: false,
        sequelize
