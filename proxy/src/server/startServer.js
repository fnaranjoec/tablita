...
const configurations = {
    ...
    production: { ssl: true, port: 443, hostname: 'tablita.veritasoft.site' },
...
app.use(createProxyMiddleware("/graphql", {
    "target": `http://${ENVIRONMENT=='development' ? 'localhost' : '67.205.139.228'}:7000/graphql`,
    "secure": false,
    "logLevel": "debug",
    // "pathRewrite": {
    //     "^/": ""
...
app.use(createProxyMiddleware("/ecommerce", {
    "target": `http://${ENVIRONMENT=='development' ? 'localhost' : '67.205.139.228'}:7001/ecommerce`,
    "secure": false,
    "logLevel": "debug",
    // "pathRewrite": {
    //     "^/": ""
