...
const createBrandResolver = async (obj,{customer_id, brand_name, brand_slug, brand_desc, brand_prefix, brand_picture, file=null}) => {
    ...
    if (uploaded.length>0) {
        ...
        return await ProductsService.createBrand({customer_id, brand_name, brand_slug, brand_desc, brand_prefix, brand_picture});
    }
