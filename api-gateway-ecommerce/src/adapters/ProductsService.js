...
export default class UsersService {
    ...
    // {brand_id, customer_id, brand_name, brand_slug, brand_desc, brand_prefix, brand_picture, brand_status}
    static async updateBrand({args}) {

        const body = await got.put(`${PRODUCT_SERVICE_URI}/brands/${args.brand_id}`, {
            // json: {customer_id, brand_name, brand_slug, brand_desc, brand_prefix, brand_picture, brand_status}
            json: {args}
        }).json();
